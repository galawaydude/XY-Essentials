...
const Account = () => {
  const [addresses, setAddresses] = useState([
    { street: "123 Main St", city: "City A", state: "State A", postalCode: "12345" },
    { street: "456 Side Rd", city: "City B", state: "State B", postalCode: "67890" },
  ]);
  const [orders] = useState([
    { id: 1, date: '2024-09-30', status: 'Delivered', total: '$49.99' },
    { id: 2, date: '2024-08-15', status: 'Shipped', total: '$19.99' },
  ]);
    ...
    <div className="acc-page">
      ...
      <section className="acc-section acc-past-orders">
        ...
        <ul className="acc-orders-list">
          {orders.map(order => (
            <li className="acc-order-item" key={order.id}>
              <p className="acc-order-detail"><strong>Order ID:</strong> {order.id}</p>
              <p className="acc-order-detail"><strong>Date:</strong> {order.date}</p>
              <p className="acc-order-detail"><strong>Status:</strong> {order.status}</p>
              <p className="acc-order-detail"><strong>Total:</strong> {order.total}</p>
